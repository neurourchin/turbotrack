 ...
 *
 */
void FindWormBoundary(WormAnalysisData* Worm, WormAnalysisParam* Params, CvPoint* prevpt){ //,WormGeom* PrevWorm
	...
	//if (Params->ApertureOn) {
		...
		cvZero(CircleROI);
		 //if ((prevpt->y) !=0){
			 //cvCircle(CircleROI,*(prevpt),100,cvScalar(255,255,255),-1,CV_AA,0);
