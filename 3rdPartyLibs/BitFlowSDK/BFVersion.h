...
#define BF_PRODUCT_VERSION_NUMBERS		6, 2, 0, 1
#define BF_PRODUCT_VERSION_STRING		"6.2.0.1\0"

#define BF_FILE_VERSION_NUMBERS			6, 2, 0, 1
#define BF_FILE_VERSION_STRING			"6.2.0.1\0"
