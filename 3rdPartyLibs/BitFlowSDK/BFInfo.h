...
// The following section is for user level only definitions.
    ...
    typedef struct _BFInfoUsr
    {
		...
		BFU32				DebugCom;						// Set to True to output all CXP Read/Writes
		...
		// Store current camera parameters here for fast recall
		BFU32				CacheXSize;					// Camera XSize
		BFU32				CacheYSize;					// Camera YSize
		BFU32				CacheTimeout;				// Camera Timeout
...
// The following section is for Kernel only definitions.
    ...
    typedef struct _BFInfoKrn 
    {
		...
		BFBOOL				CollectCXPMetaData;			// Set to true to enable collection of CXP image header meta data
