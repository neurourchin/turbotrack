...
typedef enum _BFRC_Enum
{
    ...
    BF_BFGTL_TLINTERFACE_ID_ERR,        // Unable to generate a TLInterface ID for the board.
    ...
    BF_BFGTL_SYS_INIT_ERR,              // Unable to initialize the GenTL TLSystem module.
    BF_BFGTL_IF_INIT_ERR,               // Unable to initialize the GenTL TLInterface module.
    ...
    BF_BFGTL_UNKNOWN_EXCEPTION_ERR,     // An unknown exception was internally.
