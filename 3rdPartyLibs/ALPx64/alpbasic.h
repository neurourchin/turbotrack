...
/***************************************************************************/
/**                                                                       **/
/**   © 2004-2011 ViALUX GmbH. All rights reserved.                       **/
/**                                                                       **/
/***************************************************************************/
/**                                                                       **/
/**   Version:        4                                                   **/
...
#else /* __cplusplus */
#define ALPBASIC_API __declspec(dllimport)
#endif /* __cplusplus */
...
enum ALPB_RETURNCODES {
	...
	ALPB_ERR_API_DLL_MISSING	= 0x8000000E,	/*	The responsible API DLL could not be loaded by the ALPX wrapper. */
	ALPB_ERR_API_DLL_UNKNOWN	= 0x8000000F,	/*	This ALP device version is not supported by this ALPX wrapper version. */
};
...
enum ALPB_DLL_CONTROLTYPES {
	...
	ALPB_DLL_DEV_AVAILABLE_VERSIONS	= 3,
};
...
enum ALPB_DMDTYPES {
	...
	ALPB_DMDTYPE_WUXGA_096A	= 7,	// (WUXGA 0.96" Type A),
